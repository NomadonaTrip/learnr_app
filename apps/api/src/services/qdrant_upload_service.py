"""
Qdrant Upload Service for managing question vector uploads.

This service handles uploading question embeddings to Qdrant with proper
payload structure, batching, and idempotency support.
"""
